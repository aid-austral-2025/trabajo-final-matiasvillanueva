...
american_genres_count <- video_game_sales %>% 
  ...
  labs(title = "Cantidad de Juegos por Género - Consolas Americanas",
...
ggplot(aes(x = n, y = reorder(Genre, n), fill = Genre)) +
geom_col(show.legend = FALSE) +
labs(title = "Cantidad de Juegos por Género - Consolas Japonesas",
x = "Cantidad de Juegos", y = "Género") +
scale_fill_discrete() +
scale_x_continuous(labels = scales::comma)
...
tidyr::pivot_longer(cols = c(JP_in_USA, US_in_JP),
names_to = "Flow", values_to = "Sales") %>%
mutate(Flow = recode(Flow,
"JP_in_USA" = "Japonesas en America",
"US_in_JP" = "Americanas en Asia"))

cross_market_plot <- ggplot(cross_market_by_year,
aes(x = Year, y = Sales, color = Flow)) +
geom_line(linewidth = 1.2) +
geom_point(size = 2) +
scale_color_manual(values = c("Japonesas en America" = "#d62728",
...
geom_point(size = 2) +
scale_color_manual(
values = c("North America" = "#1f77b4", # azul América
"Asia" = "#d62728") # rojo Japón
) +
scale_x_continuous(breaks = seq(1986, 2016, by = 5)) +
scale_y_continuous(labels = scales::comma) +
labs(
